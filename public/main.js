...
(() => {
    ...
    $("#aboutLink").click(() => {
        ...
        $("#contentDiv").html(`
            ...
            <h2> Welcome! </h2>
            <br>
            <span> My name is David Gallula </span>
            <br>
            <span> <span class="bolderTextAboutPage"> Crypto-Byte </span> owner. </span>
            <br>
            <span> I am 38 years old, </span>
            <br>
            <span> I live in  in Jerusalem, Israel. </span>
            <br>
            <br>

            <p> this is a new version of my second project about Bitcoins for John Bryce Institut , using Ajax and jquery.</P>
